...
class IMGParser:
    def __init__(self, currentPath):
        ...
        #stop bus topic sub
        self.bus_move_stop = rospy.Subscriber('/stop_bus',Float64, self.bus_move_callback)
        self.bus_stop_flag = False

    def bus_move_callback(self, msg):
        if msg.data > 0:
            self.bus_stop_flag = False
        else:
            self.bus_stop_flag = True
